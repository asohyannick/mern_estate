...
export default function Search() {
  return (
    <div className='flex flex-col md:flex-row'>
        <div className="p-7 border-b-2 md:border-r-2  md:min-h-screen">
            <form className='flex flex-col gap-8'>
                <div className="flex items-center gap-2">
                    ...
                    <input type="text"  id="search" placeholder='Search...' className='p-3 w-full rounded-lg'/>
                </div>
                ...
                <div className="">
                    <label className='font-semibold whitespace-nowrap mr-2'>Sort:</label>
        ...
        <div className="">
            <h1 className='text-3xl font-semibold border-b text-slate-700 mt-5'>Listing Result</h1>
        </div>
    </div>
  )
}
